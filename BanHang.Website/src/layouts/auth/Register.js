...
export default function Register() {
  ...
  useEffect(() => {
    ...
    if (isError) {
      ...
      errorMessage ? toast.error(errorMessage) : toast.error("Xác nhận mật khẩu không chính xác");
      dispatch(clearState());
    }
  }, [isSuccess, isError])
          ...
          {formikProps => {
            ...
            return (
              <Form className="register">
                ...
                />
                <label htmlFor="confirmPassword"><span className={'text-danger'}>* </span>Confirm password:</label>
                <FastField
                ...
                <div className="text-left mt-3">
                  ...
                  <Link to={'/login'}><small className="reset float-right">Login</small></Link>
                </div>
              </Form>
            )
          }}
