...
export default function Home(props) {
  ...
  return (
    <>
      ...
      {/*<div className="topCategories m-t-100">*/}
      {/*  <div className="container">*/}
      {/*    <div className="row">*/}
      {/*      <div className="col-12">*/}
      {/*        <div className="topCategories__header d-flex justify-content-between m-b-20">*/}
      {/*          <h2 className="topCategories__header-title ">Top Categories</h2>*/}
      {/*          <div className="topCategories__header-btn">*/}
      {/*            <CustomBtn2 title="More categories" />*/}
      {/*          </div>*/}
      {/*        </div>*/}
      {/*      </div>*/}
      {/*    </div>*/}
      {/*    <div className="row">*/}
      {/*      <div className="col-12">*/}
      {/*        <div className="topCategories__box">*/}
      {/*          {categories.map((category) => (*/}
      {/*            <CategoryCard*/}
      {/*              index={category.id}*/}
      {/*              categoryName={category.name}*/}
      {/*              src={category.img}*/}
      {/*              productQty={category.productQty}*/}
      {/*            />*/}
      {/*          ))}*/}
      {/*        </div>*/}
      {/*      </div>*/}
