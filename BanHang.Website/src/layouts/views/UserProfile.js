...
function UserProfile(props) {
  ...
  function onLoad() {
    const { fullName, userName, age, birthday, gender, phoneNumber, address, email } = userInfo;
            ...
            <Row>
              <Col sm={3}>
                <Nav variant="pills" className="flex-column user__profile-nav">
                  ...
                  <Nav.Item>
                    <Nav.Link className={"d-flex align-items-center"} eventKey="third">
                          ...
                          formikProps => {
                            return (
                              <Form className={'tab__content-form'}>
                                ...
                                {
                                  userInfo ?
                                    <Button variant={'primary'} className={'tab__content-btn'} type="submit">Save</Button>
                                    :
                                    <Button disabled variant={'primary'} className={'tab__content-btn'}
