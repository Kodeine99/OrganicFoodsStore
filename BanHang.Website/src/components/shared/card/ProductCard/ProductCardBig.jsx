...
import { FaRegStar, FaStarHalfAlt, FaStar, FaCheckCircle } from "react-icons/fa";
...
const ProductCardBig = ({
  ...
  return (
    <div className="product-details__card d-flex">
      <Col sm={5}>
      ...
      <Col sm={7}>
        <div className="product-details__card-content">
          ...
          <div className="product-details__card-des">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut debitis deleniti eum facilis harum ipsam. Fugit incidunt officia reiciendis repellendus!</p>
          ...
          <div className="product-details__card-qty d-flex mt-4">
            ...
            <Count count={count} maxCount={availableQuantity} setCount={count=>setCount(count)}/>
            {/* {console.log("countQty",count)} */}
          </div>
          <div className="p-content__btn mt-4">
            <BtnAddCart productId={productId} title="Add to card" Quantity={count}/>
